...
public class VerificationCodeServlet extends HttpServlet {
    ...
    private final int VERIFY_SIZE = 4;
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // 生成随机的验证码字串
        String verifyCode = generateVerifyCode(VERIFY_SIZE, VERIFY_CODES);
        ...
        // 生成验证码图片
        outputImage(IMAGE_WIDTH, IMAGE_HEIGHT, response.getOutputStream(), verifyCode);
    }
