        ...
        <form class="form-horizontal" action="/register.do" method="post" enctype="multipart/form-data" onsubmit="return checkForm()">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <label class="radio-inline">
                        <input type="radio" name="sex" value="u" checked> 保密
                    </label>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputBirthDay" name="birthday" readonly>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <p class="help-block">支持jpg、jpeg、gif、png、bmp格式的图片</p>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <label class="checkbox-inline">
                        <input type="checkbox" value="1" name="interest" checked> 后端
                    </label>
                    <label class="checkbox-inline">
